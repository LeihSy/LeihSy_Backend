...
public class BookingTransactionService {
    ...
    public TransactionDTO generateToken(Long bookingId) {
        ...
        // 1. AUTORISIERUNG: Nur der Entleiher (oder Gruppenmitglied) darf den Code generieren
        ...
        // 2. TYP & STATUS automatisch bestimmen
        ...
        log.info("Token generated by Student for Booking {} (Type: {}): {}", bookingId, type, token);
